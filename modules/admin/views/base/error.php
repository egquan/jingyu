...
$this->title = $name;
$arr = $exception->statusCode ?? 500;
$codeArray = str_split($arr);
?>
<style>
...
<div class="error">
    <div class="container-floud">
        <div style="text-align: center">
            ...
            <h2 class="h1"><?= nl2br(Html::encode($message)) ?></h2>
        </div>
    </div>
</div>
...
<script>
    ...
    loop3 = setInterval(function () {
        if (i > 40) {
            clearInterval(loop3);
            document.querySelector('.thirdDigit').textContent = <?=$codeArray[0]?>;
        } else {
    ...
    loop2 = setInterval(function () {
        if (i > 80) {
            clearInterval(loop2);
            document.querySelector('.secondDigit').textContent = <?=$codeArray[1]?>;
        } else {
    ...
    loop1 = setInterval(function () {
        if (i > 100) {
            clearInterval(loop1);
            document.querySelector('.firstDigit').textContent = <?=$codeArray[2]?>;
        } else {
