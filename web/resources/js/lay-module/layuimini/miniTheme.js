        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="http://www.chunblog.com/" target="_blank"><i class="layui-icon layui-icon-website" style="font-size: 19px;"></i>开发者:春风</a>\n' +
                    '<a class="more-menu-item"><i class="layui-icon layui-icon-login-wechat" style="font-size: 16px;"></i>微信:binzhou5</a>\n' +
                    '<a class="more-menu-item"><i class="layui-icon layui-icon-login-qq"></i>QQ:860646000</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
